...
from Oneforall.utils.database import get_served_chats, get_served_users, get_sudoers
...
from Oneforall.cplugin.setinfo import get_logging_status, get_log_channel
        ...
        if C_LOG_STATUS:  # Agar logging enabled hai
            ...
            try:
                await client.send_message(
                    ...
                    text=f"<b><i>📽️ {message.from_user.mention} ᴊᴜꜱᴛ ꜱᴛᴧʀᴛєᴅ ᴛʜє ʙσᴛ. 🚀</i></b>\n\n"
                        f"<b><i>♻️ᴜsᴇʀ ɪᴅ ➫ <code>{message.from_user.id}</code></i></b>\n"
                        f"<b><i>⛩️ᴜsᴇʀɴᴀᴍᴇ ➫ @{message.from_user.username}</i></b>",
                )
